...
const ACCEPTED_TYPES = '.pdf,.doc,.docx,.xlsx,.xls,.csv,.txt,.md,.json';
const FILE_ICONS = { pdf: '📄', doc: '📝', docx: '📝', xlsx: '📊', xls: '📊', csv: '📊', txt: '📃', md: '📃', json: '📋' };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      >
        ...
        <span>{isDragging ? 'Drop to attach' : 'Attach files — PDF, Word, Excel, CSV, TXT, MD, JSON'}</span>
        <input
          ref={fileInputRef}
          type="file"
